...
# 1 "C:/Program Files/Microchip_/MPLABX/v5.45/packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8\\pic\\include\\__null.h" 1 3
...
void step_handler(_Bool direction);
...
void speed_handler(void){
    ...
    if(speed_stimer > 10U){
        ...
        speed_value = 2700U - (speed_value*200U);
    }
    else{
...
void step_handler(_Bool direction){
    ...
    switch (StepNum) {
        case 1:
            ...
            LATAbits.LATA5 = 1;
            LATCbits.LATC2 = 1;
            if(((4U == 1U)||(4U == 3U))&&(motor_dir == 0)){
                 StepNum = 7;
            }
            else if(((4U == 2U)||(4U == 4U))&&(motor_dir == 1)){
                 StepNum = 7;
            }
            else{
        ...
        case 6:
            ...
            if(((4U == 1U)||(4U == 3U))&&(motor_dir == 1)){
                 StepNum = 0;
            }
            else if(((4U == 2U)||(4U == 4U))&&(motor_dir == 0)){
                 StepNum = 0;
            }
            else{
